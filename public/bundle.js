...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = _react2.default.createElement(
	  ...
	  _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      _reactRouter.Route,
	      { name: 'posts', component: _Posts2.default },
	      _react2.default.createElement(_reactRouter.Route, { path: '/posts/:postId', component: _postContainer2.default })
	    )
	  )
	);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Welcome = function (_React$Component) {
	  ...
	  function Welcome() {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Welcome).call(this));
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _staticContentContainer = __webpack_require__(222);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _StaticContent = __webpack_require__(223);
	...
	var staticContentContainer = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_StaticContent2.default);
	
	exports.default = staticContentContainer;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _indicatorContainer = __webpack_require__(224);
	
	var _indicatorContainer2 = _interopRequireDefault(_indicatorContainer);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var StaticContent = function StaticContent(_ref) {
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      'h3',
	      null,
	      'Example of handling static data'
	    ),
	    _react2.default.createElement(
	      'div',
	      { className: 'static-items-button col-md-2' },
	      _react2.default.createElement(
	        'button',
	        { type: 'button', className: 'btn btn-primary', onClick: onClick },
	        'Update Data'
	      ),
	      _react2.default.createElement(_indicatorContainer2.default, null)
	    ),
	    _react2.default.createElement(
	      'div',
	      { className: 'col-md-10' },
	      _react2.default.createElement(
	        ...
	        staticItems.map(function (staticItem, index) {
	          return _react2.default.createElement(
	            'div',
	            { key: index },
	            staticItem.text
	...
	StaticContent.propTypes = {
	  staticItems: _react.PropTypes.arrayOf(_react.PropTypes.shape({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Indicator = __webpack_require__(225);
	...
	var indicatorContainer = (0, _reactRedux.connect)(mapStateToProps)(_Indicator2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  var handler = (0, _redux.bindActionCreators)(fetchRemoteItems, dispatch);
	  return {
	    onClick: handler.fetchRemoteItems
	  };
	};
	
	var remoteContentContainer = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_RemoteContent2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RemoteContent = function RemoteContent(_ref) {
	  var remoteItems = _ref.remoteItems;
	  var onClick = _ref.onClick;
	  return _react2.default.createElement(
	    'div',
	    ...
	    _react2.default.createElement(
	      'h3',
	      null,
	      'Example of handling remote data'
	    ),
	    _react2.default.createElement(
	      'div',
	      { className: 'static-items-button col-md-2' },
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'div',
	        { className: remoteItems.isFetching ? 'static-items-container' + ' loader' : 'static-items-container' },
	        _react2.default.createElement(
	          'table',
	          { className: 'table' },
	          _react2.default.createElement(
	            'tbody',
	            null,
	            remoteItems.items.map(function (remoteItem, index) {
	              return _react2.default.createElement(
	                'tr',
	                { key: index },
	                _react2.default.createElement(
	...
	RemoteContent.propTypes = {
	  remoteItems: _react.PropTypes.shape({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Posts = function (_React$Component) {
	  ...
	  function Posts() {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Posts).call(this));
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  var handler = (0, _redux.bindActionCreators)(remoteItemActionHandler, dispatch);
	  return {
	...
	var PostContainer = function (_React$Component) {
	  ...
	  _createClass(PostContainer, [{
	    ...
	    value: function componentDidMount() {
	      var item = this.props.selectedRemoteItem;
	      if (!item || !item.userId) {
	  ...
	  function PostContainer() {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(PostContainer).call(this));
	  }
	
	  _createClass(PostContainer, [{
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(_Post2.default, { post: this.props.selectedRemoteItem });
	    }
	  }]);
	...
	PostContainer.propTypes = {
	  selectedRemoteItem: _react.PropTypes.object.isRequired,
	  fetchRemoteItem: _react.PropTypes.func.isRequired
	};
	
	var Connector = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(PostContainer);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var appReducer = (0, _redux.combineReducers)({
	  staticItems: _staticItems2.default,
	  remoteItems: _remoteItems2.default,
	  selectedRemoteItem: _selectedRemoteItem2.default
	});
...
/***/ function(module, exports) {
	...
	var staticItems = function staticItems() {
	  var state = arguments.length <= 0 || arguments[0] === undefined ? [] : arguments[0];
	  var action = arguments[1];
...
/***/ function(module, exports) {
	...
	var remoteItems = function remoteItems() {
...
/***/ function(module, exports) {
	...
	var selectedRemoteItem = function selectedRemoteItem() {
	  var state = arguments.length <= 0 || arguments[0] === undefined ? {
	    isFetching: false,
	    item: {}
	  } : arguments[0];
